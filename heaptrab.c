...
#include <string.h>
#include <time.h>
//professor, para acessar o registro, criei uma chave para cada cpf gerado, a chave consiste nos primeiros 9 digitos
//sem os 2 digitos verificadores, do cpf, portanto, no arquivo registros.txt que esta presente em todos os programas
...
void carregar_dados(THeap* heap) {
    ...
    fclose(f); printf("Dados carregados\n");
}
int main() {
    srand(time(NULL));
